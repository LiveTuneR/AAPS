...
class Version: PumpObjectModel {
    ...
    constructor(command: PumpCommand) : super(PumpObject.FirmwareEntry) {
        _fwMajor = null
        _fwMinor = null
        _proto = null
    ...
    constructor(fwMajor: Int, fwMinor: Int, protocolVersion: ProtocolVersion) : super(PumpObject.FirmwareEntry) {
        _fwMajor = fwMajor
        _fwMinor = fwMinor
